...
#define SSID_AP "idea-AP" // for AP mode
...
server.on("/LED1", HTTP_GET, handle_LED1);
server.on("/LED0", HTTP_GET, handle_LED0);
...
html += "<input class=\"button button-on\" type=\"button\" value=\"1\" onclick=\"window.location.href='/LED1'\">\n";
html += "<br><br>\n";
html += "<input class=\"button button-on\" type=\"button\" value=\"2\" onclick=\"window.location.href='/LED0'\">\n";
html += "<br><br>\n";
html += "</form>\n";
html += "</div>\n";
html += "</body>\n";
